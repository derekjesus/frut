...
$(document).on ('ready',function() {
    ...
    $(window).scroll(function() {
        if ($(this).scrollTop() > pos.top + menu.height() && menu.hasClass('set') && $(this).scrollTop() > 500) {
            menu.fadeOut('fast', function() {
                $(this).removeClass('set').addClass('sticky').fadeIn('fast');
            });
        } else if ($(this).scrollTop() <= pos.top + 500 && menu.hasClass('sticky')) {
    ...
    jQuery('.banner-full2-height').revolution({
        delay: 9000,
        startwidth: 1170,
        startheight: 1020,
        hideThumbs: 100,
    ...
    jQuery('.banner-full3-height').revolution({
        delay: 9000,
        startwidth: 1170,
        startheight: 1325,
        hideThumbs: 100,
    ...
    jQuery('.banner-full4-height').revolution({
        delay: 9000,
        startwidth: 1170,
        startheight: "100vh",
        hideThumbs: 100,
    ...
    //mobile counter
    if ($(window).width() > 479) {
        $('.milestone-counter').on('inview', function(event, visible) {
